...
#SBATCH --time=4:00:00
#SBATCH --output=/scratch/sunwbgt_root/sunwbgt98/xysong/Deep-SVDD-PyTorch/out/out-mnist-imagenet.log


mkdir log/mnist-imagenet

cd src

python main.py "mnist-imagenet" cifar10_LeNet "../log/mnist-imagenet" ../data \
