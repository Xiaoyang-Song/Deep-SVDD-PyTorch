...
#SBATCH --time=4:00:00
#SBATCH --output=/scratch/sunwbgt_root/sunwbgt98/xysong/Deep-SVDD-PyTorch/out/out-mnist-svhn.log


mkdir log/mnist-svhn

cd src

python main.py "mnist-svhn" cifar10_LeNet "../log/mnist-svhn" ../data \
